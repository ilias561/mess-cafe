          ...
          {upcomingEvents.length > 0 ? (
            ...
            <div className="ui-card-elevated mt-10 rounded-[2px] border border-line/40 bg-bone-warm px-8 py-14 text-center md:py-20">
              ...
              <a
                ...
                className="ui-interactive mt-8 inline-flex min-h-[44px] items-center justify-center rounded-full bg-mustard px-8 py-3.5 font-sans text-sm font-medium text-ink-dark transition-colors duration-150 hover:bg-amber"
              >
                Ακολούθησέ μας →
              </a>
            </div>
