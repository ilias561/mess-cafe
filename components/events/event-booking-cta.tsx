  ...
  return (
    <section className="bg-forest px-6 py-24 md:px-12 md:py-32">
      <div className="mx-auto max-w-[1400px]">
        ...
        <h2 className="mt-4 max-w-[18ch] font-serif text-[clamp(26px,4.2vw,52px)] leading-[1.05] tracking-[-0.02em] text-charcoal">
        ...
        <div className="mt-8 flex flex-wrap gap-4">
          <Link
            ...
            className="ui-interactive inline-flex min-h-[44px] items-center justify-center rounded-full bg-mustard px-8 py-3.5 font-sans text-sm font-medium text-ink-dark hover:bg-amber"
          >
            Κράτησε θέση
          </Link>
          <a
            ...
            className="flex min-h-[44px] items-center gap-3 rounded-full bg-[#25D366] px-8 py-4 font-sans text-[13px] uppercase tracking-[0.16em] text-white transition-colors hover:bg-[#1EBE5A]"
          >
            WhatsApp
          </a>
        </div>
