    ...
    try {
      const response = await fetch('https://api.web3forms.com/submit', {
        ...
        body: JSON.stringify({
          ...
          subject: 'Νέα επικοινωνία από το website',
      ...
      if (!response.ok || payload?.success === false) throw new Error('Web3Forms failed')
      setContactStatus('success')
      form.reset()
    } catch {
      setContactStatus('error')
      setContactError('Δεν ήταν δυνατή η αποστολή. Δοκίμασε ξανά.')
    } finally {
