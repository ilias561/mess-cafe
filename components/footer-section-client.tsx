  ...
  return (
    <footer id="footer" className="bg-forest px-6 pt-24 pb-0 text-charcoal md:px-12">
      <div className="mx-auto max-w-[1400px]">
        ...
        >
          ...
          <div className="relative h-[360px] overflow-hidden rounded-2xl border border-mustard/20">
            {mapConsent ? (
              ...
              <div className="flex h-full flex-col items-center justify-center gap-4 bg-forest/80 px-6 text-center">
                ...
                <p className="max-w-[28ch] font-sans text-[13px] leading-relaxed text-charcoal/70">
        ...
        <Reveal className="flex flex-col gap-3 border-t border-line py-8 text-[11px] text-charcoal/40 sm:flex-row sm:items-center sm:justify-between">
