...
const goals = [
  {
    num: '01',
    title: 'Modular',
    body: 'Τα πάντα στον χώρο κινούνται, η κίνηση είναι η βασικότερη αρχή της ζωής (τα πάντα ρεί). Αυτό επιτρέπει στον χώρο να μετατρέπεται από τη μια στιγμή στην άλλη, αλλάζοντας χρηστικότητα ανάλογα με την περίσταση ή τις ανάγκες.',
  },
  {
    num: '02',
    title: 'Events',
    body: 'Ο χώρος αλλάζει χρηστικότητα ανάλογα με την περίσταση.',
  },
  {
    num: '03',
    title: 'Sustainable',
    body: 'Παρασκευάζουμε πιάτα με φρέσκες και τοπικές ύλες με όσο το δυνατόν λιγότερη επεξεργασία. Χρησιμοποιούμε καθαρές πρώτες ύλες και τεχνικές που αυξάνουν την διατροφική αξία χωρίς να υστερούν σε γεύση. Μέρος των προϊόντων που θα συναντήσετε στα πιάτα μας προέρχεται από τον δικό μας μπαξέ και τα κτήματά μας — γάλα αμυγδάλου, γάλα βρώμης και καρυδιού, iceberg, τοματίνι.',
  },
  {
    num: '04',
    title: 'Space',
    body: 'Όλα τα παραπάνω λοιπόν συνθέτουν τον αγαπημένο μας και ελπίζουμε αγαπημένο σας χώρο.',
  },
]
