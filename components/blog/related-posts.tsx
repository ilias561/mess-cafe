  ...
  return (
    <section className="px-6 py-24 md:px-12 md:py-32">
      <div className="mx-auto max-w-[1400px]">
        <p className="font-sans text-[11px] uppercase tracking-[0.16em] text-olive">ΣΧΕΤΙΚΑ ΑΡΘΡΑ</p>
        <h2 className="mt-5 font-serif text-[clamp(22px,3.5vw,40px)] leading-[1.08] tracking-[-0.01em] text-charcoal">
