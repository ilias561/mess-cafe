...
export default function BookingInfo({ settings }: BookingInfoProps) {
  ...
  return (
    <aside className="ui-card-elevated mt-8 border border-line/30 bg-bone-warm p-5 md:mt-0 md:sticky md:top-28 md:p-8">
      <p className="font-sans text-[11px] uppercase tracking-[0.16em] text-olive">ΠΛΗΡΟΦΟΡΙΕΣ</p>
      ...
      <div className="mt-8 border-t border-line/40 pt-8">
        <a
          ...
          className="ui-interactive inline-flex w-full items-center justify-center gap-3 rounded-full bg-[#25D366] px-8 py-4 font-sans text-[13px] uppercase tracking-[0.18em] text-white transition-colors duration-150 hover:bg-[#1EBE5A]"
        >
          Στείλε μας WhatsApp
        </a>
